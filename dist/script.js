...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_showImg__WEBPACK_IMPORTED_MODULE_6__["default"])();
});
...
var changeModalState = function changeModalState(state) {
  var windowsDesign = document.querySelectorAll(".balcon_icons_img"),
        ...
        switch (item.nodeName) {
          ...
          case "INPUT":
            if (item.getAttribute("type") === "checkbox") {
              ...
              elem.forEach(function (itemCheckbox, j) {
...
var checkNumInputs = function checkNumInputs(selector) {
  ...
  numInputs.forEach(function (phoneInput) {
...
/* harmony import */ var _chekNuminput__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chekNuminput */ "./src/js/modules/chekNuminput.js");
...
var forms = function forms(state) {
  ...
  Object(_chekNuminput__WEBPACK_IMPORTED_MODULE_4__["default"])('input[name="user_phone"]');
  ...
  var postDate = function postDate(data, url) {
    var resData;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _context.next = 6;
            return regeneratorRuntime.awrap(resData.text());
...
var modal = function modal() {
  function bindModal(trigerSelecter, popupSelector, closeSelector) {
    ...
    var triger = document.querySelectorAll(trigerSelecter),
  ...
  bindModal(".popup_calc_profile_button", ".popup_calc_end", ".popup_calc_end_close", false); //showpopupByTime(".popup", 60000);
};
...
var showImg = function showImg() {
  ...
  containerWorks.addEventListener("click", function (e) {
    e.preventDefault();
    var target = e.target;
...
var tabs = function tabs(headerTabsSelector, tabsSelector, contentTabSelector, activeClassTab) {
...
var timer = function timer(id, deadLine) {
  ...
  var gerTimeRemaining = function gerTimeRemaining(endTime) {
  ...
  var setClock = function setClock(timerSelector, endTime) {
    var timerContainer = document.querySelector(timerSelector);
    var secondsElem = timerContainer.querySelector("#seconds");
    var minutsElem = timerContainer.querySelector("#minutes");
    var hoursElem = timerContainer.querySelector("#hours");
    var daysElem = timerContainer.querySelector("#days");
    var timerInterval = setInterval(updateTimer, 1000);

    function updateTimer() {
      var time = gerTimeRemaining(endTime);
